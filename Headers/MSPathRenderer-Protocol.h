...
- (void)renderPath:(MSPath *)arg1 style:(MSImmutableStyle *)arg2 layer:(MSImmutableStyledLayer *)arg3 inRect:(struct CGRect)arg4 fillColor:(struct CGColor *)arg5 context:(MSRenderingContext *)arg6;
@end
