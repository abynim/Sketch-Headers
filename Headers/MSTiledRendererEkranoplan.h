...
@class CALayer, MSFlowItemCollector, MSMetalRenderer, MSOverlayRenderer, MSRenderInstruction, MSRenderingCache, MSRenderingDriver, MSTileMipLevel, NSArray, NSDictionary, NSString, NSView;
@protocol MSTiledRendererHostView, OS_os_log;

@interface MSTiledRendererEkranoplan : NSObject <MSTilingSystemProvider>
{
...
- (void)_doContentRasterisationInRects:(CDStruct_3b01f0aa *)arg1 forPage:(id)arg2 zoomValue:(double)arg3 backingScale:(double)arg4 instruction:(id)arg5 contentsScale:(double)arg6 tiles:(id)arg7;
