...
+ (struct CGImage *)createImageForRect:(struct CGRect)arg1 blurRadius:(double)arg2 saturation:(double)arg3 options:(long long)arg4 colorSpace:(struct CGColorSpace *)arg5 drawingBlock:(CDUnknownBlockType)arg6;
- (void).cxx_destruct;
...
- (struct CGImage *)createImageFromContext:(struct CGContext *)arg1 saturation:(double)arg2 options:(long long)arg3;
- (struct CGContext *)createContextForRect:(struct CGRect)arg1 blurRadius:(double)arg2 options:(long long)arg3 colorSpace:(struct CGColorSpace *)arg4 imageFreeBlock:(CDUnknownBlockType)arg5 scale:(double *)arg6;
- (struct CGImage *)createImageForRect:(struct CGRect)arg1 blurRadius:(double)arg2 saturation:(double)arg3 options:(long long)arg4 colorSpace:(struct CGColorSpace *)arg5 drawingBlock:(CDUnknownBlockType)arg6 imageFreeBlock:(CDUnknownBlockType)arg7;
- (void)saturateBuffer:(struct vImage_Buffer *)arg1 saturation:(double)arg2;
- (struct vImage_Buffer *)blurBuffer:(struct vImage_Buffer *)arg1 workingBuffer:(struct vImage_Buffer *)arg2 tempBuffer:(void *)arg3 options:(long long)arg4;
...
- (void)checkTempDataSizeForImageBuffer:(struct vImage_Buffer *)arg1 workingBuffer:(struct vImage_Buffer *)arg2;
