...
- (id)readPasteboardLayersFromPasteboard:(id)arg1 document:(id)arg2 options:(unsigned long long)arg3 sender:(id)arg4;
- (id)readPasteboardLayersFromPasteboard:(id)arg1 document:(id)arg2 options:(unsigned long long)arg3;
- (id)readPasteboardLayersFromDrag:(id)arg1 document:(id)arg2;
- (id)init;
