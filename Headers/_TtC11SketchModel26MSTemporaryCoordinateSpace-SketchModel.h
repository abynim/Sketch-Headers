...
#import <SketchModel/_TtC11SketchModel26MSTemporaryCoordinateSpace.h>

@interface _TtC11SketchModel26MSTemporaryCoordinateSpace (SketchModel)
- (id)initWithLayer:(id)arg1 parentCoordinateSpace:(id)arg2;
