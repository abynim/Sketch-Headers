...
@interface MSAssetPickerController : NSViewController <MSAssetCollectionViewSourceItemProvider, MSAssetCollectionViewItemDelegate, NSCollectionViewDelegate, NSMenuDelegate>
{
