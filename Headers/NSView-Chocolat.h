...
- (void)addSubview:(id)arg1 insets:(struct NSEdgeInsets)arg2;
- (void)addSubview:(id)arg1 applyingConstraints:(CDUnknownBlockType)arg2;
...
- (id)topConstraintWithWindowContentLayoutGuide;
- (id)widthConstraint;
...
- (void)showWithIntrinsicWidth;
- (void)showWithWidth:(double)arg1;
- (void)showWithIntrinsicHeight;
