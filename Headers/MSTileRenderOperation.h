...
@class MSCGContextPool, MSContentCALayer, MSImmutableDocumentData, MSImmutablePage, MSRenderingContext, NSString;

@interface MSTileRenderOperation : NSOperation <CALayerDelegate>
{
    BOOL _shouldDrawPixelated;
    BOOL _showDrawingArea;
...
@property(nonatomic) BOOL showDrawingArea; // @synthesize showDrawingArea=_showDrawingArea;
