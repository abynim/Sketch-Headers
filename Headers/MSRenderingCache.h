...
@interface MSRenderingCache : NSObject
{
    ...
    NSMutableDictionary *_keysToRects;
}

- (void).cxx_destruct;
- (void)removeObjectsWithTraits:(unsigned long long)arg1 orOutsideRect:(struct CGRect)arg2;
- (void)removeObjectForKey:(id)arg1;
- (id)objectForKey:(id)arg1 orCreateWithBlock:(CDUnknownBlockType)arg2 addToCacheWithTraits:(unsigned long long)arg3;
- (id)objectForKey:(id)arg1;
- (void)cacheObject:(id)arg1 forKey:(id)arg2 traits:(unsigned long long)arg3 rect:(struct CGRect)arg4;
