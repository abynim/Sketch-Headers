...
- (void)applySettings:(id)arg1 withOptions:(unsigned long long)arg2 inBlock:(CDUnknownBlockType)arg3;
...
@property(readonly, nonatomic) struct CGAffineTransform accumulatedRotateFlipTransform;
@property(readonly, nonatomic) struct CGAffineTransform accumulatedTransform;
