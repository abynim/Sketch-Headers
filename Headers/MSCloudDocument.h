...
@class MSDocumentChangeCounter, NSURL, NSValue;

@interface MSCloudDocument : MSDocument
{
    NSValue *_documentChangeCount;
    long long _numberOfUploadsNotCompleted;
    MSDocumentChangeCounter *_documentChangeCounter;
}

+ (long long)numberOfFailedUploadsForDocumentURL:(id)arg1;
+ (id)numberOfFailedUploadsFileURLFromDocumentURL:(id)arg1;
+ (BOOL)autosavesInPlace;
@property(retain, nonatomic) MSDocumentChangeCounter *documentChangeCounter; // @synthesize documentChangeCounter=_documentChangeCounter;
...
- (void)performSelector:(SEL)arg1 withDelegate:(id)arg2 value:(BOOL)arg3 contextInfo:(void *)arg4;
