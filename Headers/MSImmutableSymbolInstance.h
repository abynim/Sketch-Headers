...
- (id)updateOverridesDictionary:(id)arg1 withObjectIDMapping:(id)arg2 afterChangingSymbolMasterWithID:(struct NSObject *)arg3 currentID:(struct NSObject *)arg4;
- (void)updateOverridesWithObjectIDMapping:(id)arg1 afterChangingSymbolMasterWithID:(struct NSObject *)arg2;
