...
- (void)snapItem:(id)arg1 enumerations:(id)arg2 lines:(id)arg3 visible:(BOOL)arg4 snap:(unsigned long long)arg5 resize:(BOOL)arg6 edgesMask:(long long)arg7;
...
- (id)snapItemDuringDrag:(id)arg1 allowSnaps:(unsigned long long)arg2 rulersVisible:(BOOL)arg3;
