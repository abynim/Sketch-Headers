...
@class MSAbsoluteRect, MSArtboardGroup, MSImmutableLayerAncestry, MSLayerBadgeImages, MSLayoutDimension, MSLayoutPosition, MSModelObject, MSPage, MSPath, MSStyle, MSUnitCoordinateSpace, NSHashTable, NSString;
