...
@class BCFilterInfo, BCOutlineViewController, BCOutlineViewDataController, BCPageListViewController, NSButton, NSObject, NSPopUpButton, NSSearchField, NSSplitView, NSString, NSTextField, NSView;
