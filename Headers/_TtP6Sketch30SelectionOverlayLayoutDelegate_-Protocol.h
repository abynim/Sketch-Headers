...
- (double)selectionOverlay:(MSSelectionOverlay *)arg1 layout:(_TtC17SketchControllers25MSCollectionOverlayLayout *)arg2 insetForHandleOfKind:(NSString *)arg3 atIndexPath:(NSIndexPath *)arg4;
@end
